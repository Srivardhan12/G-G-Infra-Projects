export default function Footer() {
    return (
        <div className="bg-primary-blue-400 sm:p-10 p-3 lg:xl:2xl:mt-10 sm:md:flex justify-around">
            ...
            <div className="mt-5 flex justify-center sm:md:justify-end w-5/6 mx-auto items-center rounded-lg">
                <iframe className="rounded-lg" src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3808.505508425657!2d78.60504237516382!3d17.339391883539584!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTfCsDIwJzIxLjgiTiA3OMKwMzYnMjcuNCJF!5e0!3m2!1sen!2sin!4v1745741309674!5m2!1sen!2sin" width="500" height="350" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
    )
}
